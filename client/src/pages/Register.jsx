      ...
      <div className="glass rounded-3xl p-8 w-full max-w-md animate-fade-in-up">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input required type="text" placeholder="Hasnain Khan" className={inputCls} style={inputStyle}
          ...
          <div>
            ...
            <div className="flex items-center rounded-xl overflow-hidden" style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)' }}>
              ...
              <input required type="text" placeholder="hasnain-khan" className="flex-1 px-3 py-3 text-white placeholder:text-slate-600 outline-none text-sm bg-transparent"
                onFocus={focusStyle} onBlur={blurStyle} value={form.username} onChange={set('username')} />
            </div>
            <p className="text-[11px] text-slate-600 mt-1">Your public URL: /portfolio/{form.username || 'username'}</p>
          </div>
          <div>
